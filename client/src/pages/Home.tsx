  ...
  return (
    <section className="px-4 py-8 max-w-7xl mx-auto">
      <div className="py-8 text-center">
        ...
        <div className="mt-6">
          <Link href="/editor">
            <div className="bg-primary-500 hover:bg-primary-600 text-white font-medium py-2 px-6 rounded-lg transition duration-200 inline-flex items-center cursor-pointer">
      ...
      <div>
        <div className="flex justify-between items-center mb-6">
          ...
          <Link href="/blogs">
            <div className="text-primary-500 hover:text-primary-600 font-medium cursor-pointer">View all</div>
          </Link>
        </div>
